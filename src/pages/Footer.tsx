      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-3 text-brand-silver">
                ...
                <a href="mailto:Hello@11thtemplesolutions.com" className="hover:text-brand-lime transition-colors">
                  Hello@11thtemplesolutions.com
                </a>
              </div>
              <div className="flex items-center space-x-3 text-brand-silver">
                <Phone className="h-4 w-4 text-brand-lime" />
                <a href="tel:+447312190728" className="hover:text-brand-lime transition-colors">
                  +44 7312 190 728
                </a>
              </div>
              <div className="flex items-center space-x-3 text-brand-silver">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/consultation" className="text-brand-silver hover:text-brand-lime transition-colors">Free Consultation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services/website-creation" className="text-brand-silver hover:text-brand-lime transition-colors">Website Creation</Link></li>
              <li><Link to="/services/sales-lead-tools" className="text-brand-silver hover:text-brand-lime transition-colors">Sales & Lead Tools</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-brand-silver/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="#" className="text-brand-silver hover:text-brand-lime transition-colors" aria-label="LinkedIn">
              <Linkedin className="h-5 w-5" />
            </a>
            <a href="#" className="text-brand-silver hover:text-brand-lime transition-colors" aria-label="Twitter">
              <Twitter className="h-5 w-5" />
            </a>
            <a href="#" className="text-brand-silver hover:text-brand-lime transition-colors" aria-label="Facebook">
