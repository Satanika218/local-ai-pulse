...
export const post: Omit<BlogPostType, 'id' | 'date'> = {
  ...
  excerpt: 'Not every business is ready for AI implementation. Use this comprehensive readiness assessment to evaluate your organization's preparedness and identify gaps to address.',
  content: (
    <>
...
<p>Evaluate your current technology infrastructure's capability to support AI implementations. This includes data storage capacity, processing power, and network reliability. Cloud-based solutions can address infrastructure limitations, but connectivity and integration capabilities remain important.</p>
...
<p>Evaluate organizational culture's openness to change and innovation. AI implementation requires adapting to new ways of working and accepting machine-generated recommendations. Resistance to change can significantly impact implementation success.</p>
